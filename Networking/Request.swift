...
public struct Request<Model: Decodable> {
  public typealias DecodingStrategy = (Data) async -> Result<Model, Error>
  public typealias EncodingStrategy = (any Encodable) async -> Result<Data, Error>

  public let urlComponents: URLComponents
  public let bodyToEncode: (any Encodable)?
