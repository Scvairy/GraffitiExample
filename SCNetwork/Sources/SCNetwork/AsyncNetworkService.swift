...
public final actor AsyncNetworkService: URLRequestPerforming {
  ...
  public func perform<Model: Decodable & Sendable>(
  ...
  public func performWithHeaders<Model: Decodable & Sendable>(
    _ request: Request<Model>
    ...
    do {
      ...
      default:
        let payload = try? JSONSerialization.jsonObject(with: dataResponse.data) as? [String: any Sendable]
...
private extension URLSession.HTTPError {
  init(statusCode: Int, payload: [String: any Sendable]? = nil) {
